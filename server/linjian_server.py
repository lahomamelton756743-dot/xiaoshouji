    ...
    def do_POST(self) -> None:
        ...
        if path == "/api/command":
            ...
            title_map = {
                ...
                "read_diary_entry_with_annotations": "读取日记批注", "add_diary_annotation": "保存页边纸条", "list_diary_annotations": "读取页边纸条", "mark_diary_annotations_seen": "标记纸条已看", "delete_diary_annotation": "删除页边纸条",
